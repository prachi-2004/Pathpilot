...
const Dashboard = () => {
  ...
  const enrolledPaths = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1551650975-87decea25da8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
    }
  ];
  ...
  const recommendations = [
    {
      ...
      level: 'Advanced',
      duration: '8 hours',
      image: 'https://images.unsplash.com/photo-1618221195710-dd6b7727ea9c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'
    },
    {
      id: 2,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-lg text-slate-600 max-w-2xl">
                Your learning journey continues. You're on track to complete your Full Stack Web Development path in 3 weeks.
              </p>
            </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="mt-4 text-sm font-medium text-slate-500">{stat.name}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
              <div className="px-6 py-4 border-b border-slate-100">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-bold text-slate-900">Your Learning Paths</h2>
              ...
              <div className="divide-y divide-slate-100">
                {enrolledPaths.map((path) => (
                  <div key={path.id} className="p-6 hover:bg-slate-50 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-4">
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="font-medium text-slate-900">{path.progress}%</span>
                          </div>
                      ...
                      <div className="md:w-64 mt-4 md:mt-0">
                        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-4">
                          <div className="flex items-center mb-2">
                            ...
                            <span className="text-sm text-slate-600">Last accessed {path.lastAccessed}</span>
                          </div>
                          <div className="flex items-center mb-3">
                            <Target className="w-4 h-4 text-indigo-600 mr-2" />
                            <span className="text-sm font-medium text-slate-900">{path.nextStep}</span>
                          </div>
              ...
              <div className="divide-y divide-slate-100">
                <div className="p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">Completed "JavaScript Fundamentals" module</p>
                      <p className="text-sm text-slate-500 mt-1">2 days ago • Full Stack Web Development</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">Earned "Data Visualization" badge</p>
                      <p className="text-sm text-slate-500 mt-1">3 days ago • Data Science Fundamentals</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 hover:bg-slate-50 transition-colors">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">Received Certificate: "HTML & CSS Mastery"</p>
                      <p className="text-sm text-slate-500 mt-1">1 week ago • Web Development Basics</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                {recommendations.map((rec) => (
                  <div key={rec.id} className="flex mb-5 last:mb-0 hover:bg-slate-50 p-3 rounded-xl transition-colors">
                    ...
                    <div className="ml-4">
                      <h3 className="font-medium text-slate-900 line-clamp-1">{rec.title}</h3>
                      <div className="flex items-center mt-1 text-sm text-slate-500">
                        <span className="bg-slate-100 px-2 py-0.5 rounded mr-2">{rec.type}</span>
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-2 text-indigo-100">You're 15 hours away from completing your Full Stack path!</p>
                </div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-3 text-sm text-indigo-100">
                  Complete 3 more modules to earn your Full Stack Developer certificate
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="p-6">
                <h2 className="text-xl font-bold text-slate-900 mb-4">Learning Insights</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      ...
                      <span className="px-2 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full">CSS</span>
                      <span className="px-2 py-1 bg-slate-100 text-slate-700 text-xs rounded-full">Testing</span>
                    </div>
                  </div>
                </div>
              </div>
