const abilitiesQuiz = [
  {
    question:
      "How would you rate your proficiency in the following skills? (Scale: 1 = Low, 5 = High)",
    options: [
  ...
  {
    question:
      "When faced with a difficult challenge, you typically rely on your ability to...",
    options: [
  ...
  {
    question:
      "Imagine you have to give a presentation. Which part comes most naturally to you?",
    options: [
